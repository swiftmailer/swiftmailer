...
class Swift_Transport_Esmtp_Auth_NTLMAuthenticator implements Swift_Transport_Esmtp_Authenticator
{
	...
	public function authenticate(Swift_Transport_SmtpAgent $agent, $username, $password)
	{
		try {
			...
			// Message 3 response
			$resp = $this->sendMessage3($response, $username, $password, $timestamp, $client, $agent);
	...
	protected function parseMessage2($response)
	{
		...
		return array($challenge, $context, $targetInfoH, $targetName, $domainName, $serverName, $DNSDomainName, $DNSServerName, hex2bin($targetInfoBlock), $terminatorByte);
	}
	...
	protected function sendMessage3($response, $username, $password, $timestamp, $client, Swift_Transport_SmtpAgent $agent, $v2 = true)
	{
		...
		list($challenge, $context, $targetInfoH, $targetName, $domainName, $workstation, $DNSDomainName, $DNSServerName, $blob, $ter) = $this->parseMessage2($response);
