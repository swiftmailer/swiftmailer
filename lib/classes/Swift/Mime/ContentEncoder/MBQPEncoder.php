...
class Swift_Encoder_MBQPEncoder implements Swift_Encoder
{
    ...
    $maxLineLength = 0) {
		if ($firstLineOffset>0) {
			return substr(mb_convert_encoding(str_repeat(" ", $firstLineOffset).$string, "Quoted-Printable", "UTF-8"),$firstLineOffset);
		}
		return mb_convert_encoding($string, "Quoted-Printable", "UTF-8");
	}
}