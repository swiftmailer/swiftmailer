...
class Swift_MessageAcceptanceTest extends UnitTestCase
{
  ...
  {
    Swift_Di::getInstance()->setLookup('charset', 'string:utf-8');
    Swift_Di::getInstance()->setLookup('cache', 'di:mime.arraycache');
  ...
  private function _createMessage($subject = null, $body = null,
